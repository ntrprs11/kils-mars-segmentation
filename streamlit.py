...
with col1:
    st.image("train/5971.png", caption="5971.png", use_column_width=True)
    st.image("train_mask/mask_5971.png", caption="mask_5971.png", use_column_width=True)
with col2:
    st.image("train/5972.png", caption="5972.png", use_column_width=True)
    st.image("train_mask/mask_5972.png", caption="mask_5972.png", use_column_width=True)
with col3:
    st.image("train/5973.png", caption="5973.png", use_column_width=True)
    st.image("train_mask/mask_5973.png", caption="mask_5973.png", use_column_width=True)
