...
with col1:
    st.image(cv2.cvtColor(cv2.imread("train/0.png"), cv2.COLOR_BGR2RGB), caption="0.png", use_column_width=True)
    st.image(cv2.cvtColor(cv2.imread("train_mask/mask_0.png"), cv2.COLOR_BGR2RGB), caption="mask_0.png", use_column_width=True)
with col2:
    st.image(cv2.cvtColor(cv2.imread("train/1.png"), cv2.COLOR_BGR2RGB), caption="1.png", use_column_width=True)
    st.image(cv2.cvtColor(cv2.imread("train_mask/mask_1.png"), cv2.COLOR_BGR2RGB), caption="mask_1.png", use_column_width=True)
with col3:
    st.image(cv2.cvtColor(cv2.imread("train/2.png"), cv2.COLOR_BGR2RGB), caption="2.png", use_column_width=True)
    st.image(cv2.cvtColor(cv2.imread("train_mask/mask_2.png"), cv2.COLOR_BGR2RGB), caption="mask_2.png", use_column_width=True)
