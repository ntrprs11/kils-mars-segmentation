...
with col1:
    st.image(Image.open("train/0.png"), caption="0.png", use_column_width=True)
    st.image(Image.open("train_mask/mask_0.png"), caption="mask_0.png", use_column_width=True)
with col2:
    st.image(Image.open("train/1.png"), caption="1.png", use_column_width=True)
    st.image(Image.open("train_mask/mask_1.png"), caption="mask_1.png", use_column_width=True)
with col3:
    st.image(Image.open("train/2.png"), caption="2.png", use_column_width=True)
    st.image(Image.open("train_mask/mask_2.png"), caption="mask_2.png", use_column_width=True)
